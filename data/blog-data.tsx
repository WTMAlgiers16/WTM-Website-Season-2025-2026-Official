...
//   excerpt: "A lightweight intro to Dialogflow—create, train, and deploy your own chatbot 'friend' with practical steps.",
//   content: `
//     <p>Chatbots are one of the necessary things nowadays, they help you get a lot of work done faster by one command away, either by typing or saying it.</p>
//     <p>Have you ever wondered how you can build your own? In this little intro to Dialogflow, you can do just that!</p>

//     <h2>What is Dialogflow?</h2>
//     <p>According to the official documentation, Dialogflow is a natural language understanding platform that makes it easy to design and integrate a conversational user interface into your mobile app, web application, device, bot, interactive voice response system, and so on.</p>
//     <p>In other words, Dialogflow is giving you the chance to make magic and create your own little friend, teaching it how to speak and interact with the living world!</p>

//     <h2>I want my own chatbot … NOW!</h2>
//     <p>Don’t we all just dream of creating a little talkative friend? because you can! and it’s as easy as following these steps!</p>
//     <ol>
//       <li><strong>Get comfortable in your new home:</strong> The first and only link you will need to visit is the Dialogflow official site, where you will land on a page that looks like this.</li>
//       <li><strong>Create an agent:</strong> The word “agent” is just a fancy name for your bot that Dialogflow uses—click “Create Agent,” give your creation an identity, let’s name it something pretty…</li>
//       <li><strong>What can my newborn agent do:</strong> On the left side, in “Dialogflow Essentials,” scroll down to “Small Talk”—these are predefined answers you can enable, customize, and give your bot some personality.</li>
...
//     <h2>Train my chatbot</h2>
//     <h3>1. Using intents</h3>
//     <p>Intents are your chatbot’s vocabulary. Training phrases show what users might say. When an expression matches a phrase, Dialogflow maps the intent. Add training phrases under “Add training phrases” to grow your agent’s understanding. The more you add, the more knowledgeable your bot becomes.</p>

//     <h3>2. Using prebuilt agents</h3>
//     <p>To avoid repetitive work, Dialogflow offers “Prebuilt agents.” Explore and import them to jumpstart your bot’s functionality.</p>

//     <h2>Make your bot a know-it-all</h2>
//     <p>Enable beta features and APIs, then use the Knowledge Base connector to allow your bot to answer based on sources like FAQs or articles. For example, import the “FAQ about Android” from Android’s official site. The bot learns from the FAQ but replies based on that knowledge—link responses manually to ensure it knows what to say directly.</p>

//     <h2>Conclusion</h2>
//     <p>With these few steps, you should be ready to start using Dialogflow. Knowledge doesn’t end here though—keep exploring new tips and tricks to take your new little friend to the next level!</p>
//   `,
//   author: "Alaa Guermat",
//   date: "July 27, 2021",
//   readTime: "6 min read",
...
//   content: `
//     <p>Hi there!</p>
//     <p>Welcome aboard! I hope that you’re safe, healthy, doing well and that you’ve had a great day. Even if you don’t believe that was the case, I just wanna say: kudos to you for staying strong and for making it through the day despite whatever hardships you’ve stumbled upon, now give yourself a little pat on the back and get yourself comfortable because a little ray of sunshine is coming your way, as you continue to (hopefully, mindfully) read these scribbles of mine ✨</p>

//     <p>You probably don’t know me, and I probably don’t know you either and have no idea what’s going on inside that head of yours, but I hope this article would turn into a lively wholesome conversation where you solely listen to yourself with no judgements.</p>

//     <h2>Take a moment for yourself</h2>
//     <p>The way I would love for you to start this conversation is by taking a few seconds to be fully aware of your thoughts and feelings at the moment, just be aware of them and give them the attention they need. Because it’s been a long day, and you probably didn’t have much time to focus on yourself, but this is your chance so, seize it! (it would also be great if you could write them down, it helps with keeping you conscious about them) ❤️</p>

//     <p>Now that you’ve managed to put the spotlight on yourself and classify whatever you’re feeling or thinking about (if you couldn’t yet, that’s okay! our minds sometimes get fuzzy and need a little more time to clear up the fog), let’s try to break them down one by one, shall we?</p>

//     <h2>Some kind words to hold onto</h2>
//     <p>I’m, first of all, gonna assume that you’re a student like me, going through exams or has already gone through them, and I’m gonna tell you some words that you may want to hear at the moment: This year has certainly not been easy!</p>
...
//     "Learn how to spot secure websites and create strong, memorable passwords—plus tips on staying safe online.",
//   content: `
//     <p>To find out if you are on a secure website, look in your browser on the top at the address bar. If the website is secure, you must see a padlock (usually at the beginning of the URL), or make sure the URL starts with “https” (the “s” refers to “secured”). For unsecured websites, you may find “http” or a warning symbol.</p>

//     <p>Some websites have mixed content—some pages are secure while others are not. Don’t panic! Just ensure the page is secure when entering sensitive information like passwords.</p>
...
//     <p>When you access your account, you must enter your username and password. Using something simple like “hello”, “0000”, or your name plus year of birth may seem easy to remember—but it’s extremely dangerous.</p>

//     <p>If someone wants to hack you, they will try combinations like these first, and if you reuse the same password across sites, they can easily access multiple accounts.</p>

//     <h2>Strong Password Rules</h2>
//     <ol>
//       <li>Your password must contain <strong>at least 12 characters</strong>.</li>
//       <li>Your password must include a mix of uppercase letters, lowercase letters, numbers, and special characters.</li>
//       <li>Avoid using familiar information like your name, birthdate, hobby, or your pet’s name.</li>
...
//     <p>Here are two suggested methods to create strong passwords:</p>
//     <ol>
//       <li>Type random letters (both cases), insert numbers, and sprinkle in symbols wherever you like.</li>
//       <li>Start with a sentence (e.g., “the cat eats the mouse”), rearrange the words (“cat mouse the eats the”), swap in numbers (“cat4 mo0use the 55 eats th4e”), then add special characters (e.g., “c&at4 @mo0use / the 55 eats th4e/”).</li>
//     </ol>

//     <p>You can also test password strength using online tools.</p>

//     <p>Now that you have a robust password, how do you remember it (along with others)? Use a password manager (“password handler”) like a secure vault, or keep a customized notebook in a safe place.</p>

//     <p>Finally, change your passwords regularly, especially for email accounts—if someone gains access to your email, they can reset all your other passwords. Always enable two-factor authentication whenever possible.</p>

//     <p>Until the next article, stay safe!</p>
//   `,
//   author: "Amira Lakrouf",
//   date: "June 19, 2021",
//   readTime: "3 min read",
...
//     "Explore the root causes of procrastination—from the ‘Instant Gratification Monkey’ to anxiety—and discover simple strategies to break the habit, regain focus, and reward your progress.",
//   content: `
//     <p>Procrastination, a term mildly known by some of us, a bad habit to others, and for the rest a policy that made its way into their everyday’s routine.</p>

//     <p>Tim Urban once said in a Ted Talk he animated, that the difference between the mind of a procrastinator and one of a normal person was an added creature in the procrastinator’s brain, that resided at the decision making part of the brain alongside the rational decision maker, and took the wheel whenever it was time to do some work. And this creature, which was symbolized by a monkey, only gave back the wheel if another monster showed up, deadlines.</p>

//     <p>In that context, this article will go over the simple definition of procrastination, its causes, and techniques to overcome it.</p>

//     <h2>What is Procrastination?</h2>
//     <p>Procrastination is the simple act of delaying and postponing decisions or actions. Many people, while procrastinating, are fully aware of the chores they need to realize, but still choose to waste time on things that may seem important at the time such as binge-watching some tv show, catching up on celebrity drama or breaking a new record on some game.</p>
//     <p>This act of leaving everything until there’s no time to rightfully do it is not without consequences, studies have related procrastination to bad grades in the pedagogic context and lesser paychecks in work. It also affects one’s mental state, as it can be responsible for stress among other things.</p>

//     <h2>Do You Procrastinate or Are You Just Lazy?</h2>
//     <p>Some might confuse the two, but the main difference is that procrastination is actively choosing to do something other than what you’re supposed to do, whereas laziness is more of an unwillingness to act.</p>
...
//     <h2>How to Deal with Procrastination</h2>
//     <p>Whether you procrastinate because you don’t feel like doing your task, or maybe not knowing how to do it. Whether it’s because you don’t care about it or maybe you’re waiting for the right moment to do it, demotivating and negative factors like the ones cited before are likely going to outweigh the motivation and self-confidence you have. And that’s no way to live, you need to acknowledge the problem and work towards a better lifestyle.</p>
//     <p>Try to start by establishing a set of goals; you can organize them by degree of importance in a to-do list. That way you’ll keep track of your progress. I would also recommend starting with goals that seem most realizable—you don’t want to crash and burn before you even start. Another thing that is recommended is to proceed with baby steps, and regularly. Doing a little bit every day is better than doing a lot one day and then nothing for the next week or so.</p>
//     <p>Now to avoid that this course of action will finish in the same way as your previous attempts, you will need to resist all of the triggers that usually mess up your schedule; writing down any red flag that is possible to let you go on an infinite break will possibly help you withstand it until the end of your task.</p>
//     <p>Distractions, in any shape or form, are better off eliminated—for example, if you think social media or any app on your phone will make you waste more time than what you’re planning on your break, it would feel better if you restricted yourself from touching your phone while studying/working.</p>
//     <p>And at the end of this process, if you managed to realize what you originally planned, and even if the plan wasn’t achieved, don’t forget to reward yourself and acknowledge your progress. And also, don’t give up on yourself just yet, try again tomorrow, and the day after and as many times as it takes to get it right.</p>
//     <p>And more importantly, don’t wait for tomorrow to start and don’t be afraid of the outcome.</p>
...
//   content: `
//     <p>INTRODUCTION :</p>
//     <p>Once upon a time, oil companies ruled the globe, an immense, untapped valuable asset of 18th century oil, it was the world’s most valuable resource, the key functionality of everything from the government to local companies, without it, progress would halt and economies would shrink.</p>

//     <p>Fast forward to the 21 century, a new particular wonder that amazed the world came to life, everything is equally great where performance is reaching perfection, now you are a central point in the raging tornado of change fuelled by digitization, mobilization, augmentation, automation, where the science fiction is becoming science fact.</p>

//     <p>Think about self-driving cars and machines that can learn, thinking that the way we work will never be the same, the skills we need are dramatically different, winning or losing are now happening faster than ever before.</p>

//     <p>You should ask yourself: Are you driving change or are you being driven by it? This is the power of the most useful resource of the 21st century, ‘DATA’. Machines and robots are products of data, confirming the universal truth booming in today’s digital world that all roads lead to data.</p>

//     <h2>What Is Big Data?</h2>
//     <p>To get the definition of big data we should define what is data first.</p>
//     <p>Etymologically, the word data is derived from the Latin dare, meaning ‘to give’.</p>
//     <p>In this sense, Data is commonly understood to be the raw material produced by abstracting the world into categories, measures and other representational forms that constitute the building blocks from which information and knowledge are created.</p>
//     <p>Since we now have an idea about data, we can define Big Data as a high volume, high velocity, and high variety information assets that require new forms of processing to enable enhanced decision making, insight discovery and process optimization, in other words, it’s a collection of large and complex data sets which can be processed only with difficulty by using on-hand database management tools.</p>

//     <p>Now, I’m sure you are asking yourself many questions, is it dangerous? , What is it used for? , What’s the impact of big data on mankind?</p>
//     <p>Before we get to the risks of big data, it makes sense to understand why so many organizations are trying to use it. Big data has already revolutionized many aspects of our lives.</p>
...
//     <h2>Risks & Ethical Concerns</h2>
//     <p>On the other hand, big data has a dark side as any kind of technology.</p>
//     <p>Data storage and retention is one of the most obvious risks associated with big data. When data gets accumulated at such a rapid pace and in such huge volumes, the first concern is its storage. Traditional data storage methods and technology are just not enough to store big data and retain it well. Companies today need a shift to cloud based data storage solutions to store, archive and access big data effectively.</p>

//     <p>Generally, when we talk about big data, many questions remain largely unanswered while this technology pushes ever forward.</p>
//     <p>We need to ask ourselves this question: Is it OK to track information about myself or my family? My health? My buying habits? My social interactions? And if it is permissible to track that information, under what circumstances? And who gets to access it? Who owns it?</p>
//     <p>I’m going to give you a brief answer, honestly everything can be traced and analysed—When I say everything I really mean everything—and can be used for nefarious purposes that’s gonna lead us to “Ethical issues”, in other words, Privacy problems, discrimination problems and spying.</p>
...
//     <p>At the end, I would thank you for reading this article and I really want to ask you this:</p>
//   `,
//   author: "Achour Med Bachir",
//   date: "May 23, 2021",
//   readTime: "4 min read",
