...
export const currentPartners: Partner[] = [
  {
    ...
    description: "Leading technology company supporting women in tech",
  ...
  },
  {
    ...
    description: "Innovation hub fostering diversity in technology",
  ...
  },
  {
    ...
    description: "Online learning platform for coding education",
